...
<div id="next">
    ...
    <div id="xia">
        <div id="page">
            <span>页数：</span>
            <a href="queryTrainDepartmentDEPState?current=1&depId=${depId}&state=${state}">首页</a>
            <a href="queryTrainDepartmentDEPState?current=${prepages}&depId=${depId}&state=${state}">上一页</a>
            <c:forEach  var ="i" begin="1" end="${pages}">
                <a href="queryTrainDepartmentDEPState?current=${i}&depId=${depId}&state=${state}">${i}</a>
            </c:forEach>
            <a href="queryTrainDepartmentDEPState?current=${nextpages}&depId=${depId}&state=${state}">下一页</a>
