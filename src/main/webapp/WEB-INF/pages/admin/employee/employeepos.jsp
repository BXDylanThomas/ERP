...
<div id="next">
    ...
    <div id="xia">
        <div id="page">
            <span>页数：</span>
            <a href="queryAllEmployeeByPosId?posId=${posId}&current=1">首页</a>
            <a href="queryAllEmployeeByPosId?posId=${posId}&current=${prepages}">上一页</a>
            <c:forEach  var ="i" begin="1" end="${pages}">
                <a href="queryAllEmployeeByPosId?posId=${posId}&current=${i}">${i}</a>
            </c:forEach>
            <a href="queryAllEmployeeByPosId?posId=${posId}&current=${nextpages}">下一页</a>
